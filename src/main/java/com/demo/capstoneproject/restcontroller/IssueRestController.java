...
import com.demo.capstoneproject.service.IssueService;
import com.demo.capstoneproject.service.IssuedBookService;
...
import static com.demo.capstoneproject.common.Constants.BOOK_STATUS_AVAILABLE;
...
public class IssueRestController {
    ...
    public String save(@RequestParam Map<String, String> payload) {
        ...
        for( int k=0 ; k<books.size() ; k++ ) {
            ...
            book.setStatus(String.valueOf(Constants.BOOK_STATUS_ISSUED));
    ...
    public String returnAll(@PathVariable(name = "id") Long id) {
        ...
        if( issue != null ) {
            ...
            for( int k=0 ; k<issuedBooks.size() ; k++ ) {
                ...
                book.setStatus(String.valueOf(BOOK_STATUS_AVAILABLE));
